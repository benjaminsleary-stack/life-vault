...
- 2026-08-01 — Ankle now feels fine; intends to take it easy. **Third injury since
  restarting running** (different injuries, same pattern: Achilles, knees, ankle).
  Three in roughly three months is the pattern to plan around — the half-marathon
  date should follow the injury record, not the other way round. _(interview)_
